...
class Mitra10Logger(logging.LoggerAdapter):    
    ...
    def process(self, msg, kwargs):
        ...
        component = _sanitize_log_input(self.extra.get("component", "mitra10"))
        operation = extra.get("operation") or self.extra.get("operation")
        
        # Build prefix: [mitra10][component=X][op=Y] message
        prefix_parts = [f"[mitra10][component={component}]"]
        if operation:
...
def get_mitra10_logger(component: str, extra: Optional[Dict[str, Any]] = None) -> Mitra10Logger:
    return Mitra10Logger(component, extra)
