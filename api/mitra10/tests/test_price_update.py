...
class TestSaveWithPriceUpdate(MySQLTestCase):
    ...
    def _create_product(self, name, price=10000, url=None, unit="PCS"):
        ...
        return Mitra10Product.objects.create(
            name=name, price=price, url=url or f"https://www.mitra10.com/{name.lower()}", unit=unit
        )
    ...
    def test_insert_new_product(self):
        data = [{"name": "New Product", "price": 10000, "url": "https://www.mitra10.com/new", "unit": "PCS"}]
    ...
    def test_update_existing_product_price_changed(self):
        self._create_product("Product A", 10000, "https://www.mitra10.com/a", "KG")
        data = [{"name": "Product A", "price": 12000, "url": "https://www.mitra10.com/a", "unit": "KG"}]
    ...
    def test_no_update_when_price_same(self):
        self._create_product("Product B", 10000, "https://www.mitra10.com/b", "M")
        data = [{"name": "Product B", "price": 10000, "url": "https://www.mitra10.com/b", "unit": "M"}]
    ...
    def test_anomaly_detection(self):
        ...
        for name, old_price, new_price, change in scenarios:
            self._create_product(name, old_price, f"https://www.mitra10.com/{name.lower()}", "PCS")
            data = [{"name": name, "price": new_price, "url": f"https://www.mitra10.com/{name.lower()}", "unit": "PCS"}]
    ...
    def test_no_anomaly_under_15_percent(self):
        self._create_product("Product E", 10000, "https://www.mitra10.com/e", "M")
        self._create_product("Product F", 10000, "https://www.mitra10.com/f", "PCS")

        cases = [
            [{"name": "Product E", "price": 11400, "url": "https://www.mitra10.com/e", "unit": "M"}],
            [{"name": "Product F", "price": 8600, "url": "https://www.mitra10.com/f", "unit": "PCS"}],
        ]
        for data in cases:
            self._save_and_assert(data, updated=1)

    def test_multiple_operations_and_anomalies(self):
        self._create_product("Existing 1", 10000, "https://www.mitra10.com/ex1", "PCS")
        self._create_product("Existing 2", 20000, "https://www.mitra10.com/ex2", "KG")

        mixed_data = [
            {"name": "Existing 1", "price": 11000, "url": "https://www.mitra10.com/ex1", "unit": "PCS"},  # 10% increase, auto-updates
            {"name": "Existing 2", "price": 20000, "url": "https://www.mitra10.com/ex2", "unit": "KG"},  # No change
            {"name": "New Product", "price": 15000, "url": "https://www.mitra10.com/new", "unit": "M"},  # New insert
        ]
        ...
        anomalies_data = [
            {"name": "Product I", "price": 11500, "url": "https://www.mitra10.com/i", "unit": "PCS"},
            {"name": "Product J", "price": 17000, "url": "https://www.mitra10.com/j", "unit": "KG"},
        ]
        self._create_product("Product I", 10000, "https://www.mitra10.com/i", "PCS")
        self._create_product("Product J", 20000, "https://www.mitra10.com/j", "KG")
    ...
    def test_edge_cases(self):
        invalid_data = [{"name": "Invalid", "price": -100, "url": "https://www.mitra10.com", "unit": "PCS"}]
        empty_data = []
    ...
    def test_same_name_different_variants(self):
        ...
        self._create_product("Product K", 10000, "https://www.mitra10.com/k1", "PCS")
        data_1 = [{"name": "Product K", "price": 10000, "url": "https://www.mitra10.com/k2", "unit": "PCS"}]
        data_2 = [{"name": "Product L", "price": 10000, "url": "https://www.mitra10.com/l", "unit": "KG"}]
