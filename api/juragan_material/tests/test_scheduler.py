...
class TestJuraganMaterialScheduler(unittest.TestCase):
    ...
    def test_run_with_search_keyword(self):
        ...
        self.assertEqual(result['vendors']['juragan_material']['scrape_attempts'], 1)
    ...
    def test_run_with_custom_vendors(self):
        ...
        result = scheduler.run(vendors=['juragan_material'], search_keyword='besi')
    ...
    def test_run_single_scrape_attempt(self):
        ...
        result = scheduler.run(vendors=['juragan_material'], search_keyword='paku')
    ...
    def test_run_scraper_creation_fails(self):
        ...
        with patch.object(scheduler, 'create_scraper', side_effect=Exception('Scraper error')):
            result = scheduler.run(vendors=['juragan_material'], search_keyword='test')
            self.assertEqual(result['vendors']['juragan_material']['status'], 'failed_scraper_creation')
    ...
    def test_run_products_saved(self):
        ...
        result = scheduler.run(vendors=['juragan_material'], search_keyword='cat')
        self.assertEqual(result['vendors']['juragan_material']['saved'], 2)
        self.assertEqual(result['vendors']['juragan_material']['products_found'], 2)
    ...
    def test_run_with_scrape_failure(self):
        ...
        result = scheduler.run(vendors=['juragan_material'], search_keyword='test')
        self.assertEqual(result['vendors']['juragan_material']['scrape_failures'], 1)
    ...
    def test_run_with_empty_products(self):
        ...
        result = scheduler.run(vendors=['juragan_material'], search_keyword='test')
        self.assertEqual(result['vendors']['juragan_material']['status'], 'no_products_found')
    ...
    def test_run_with_price_update_enabled(self):
        ...
        result = scheduler.run(vendors=['juragan_material'], search_keyword='test', use_price_update=True)
        self.assertIn('juragan_material', result['vendors'])
    ...
    def test_run_with_max_products_limit(self):
        ...
        result = scheduler.run(vendors=['juragan_material'], search_keyword='test', max_products_per_keyword=5)
        self.assertEqual(result['vendors']['juragan_material']['saved'], 5)
