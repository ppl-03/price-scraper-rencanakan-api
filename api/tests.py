...
from .scraper import clean_price_gemilang, scrape_products_from_gemilang_html

class ScraperLogicTests(TestCase):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
        fixture_path = Path(__file__).parent / "tests/fixtures/gemilang_mock_results.html"
